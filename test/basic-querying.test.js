...
describe('basic-querying', function() {
  ...
  describe('findByIds', function() {
    ...
    it.skip('should query by ids and condition', function(done) {
      User.findByIds([
        createdUsers[0].id,
        createdUsers[1].id,
        createdUsers[2].id,
  ...
  describe('find', function() {
    ...
    it.skip('should support "and" operator that is satisfied', function(done) {
      User.find({where: {and: [
        {name: 'John Lennon'},
        {role: 'lead'},
      ]}}, function(err, users) {
    ...
    it.skip('should support "and" operator that is not satisfied', function(done) {
      User.find({where: {and: [
        {name: 'John Lennon'},
        {role: 'member'},
      ]}}, function(err, users) {
    ...
    it.skip('should support "or" that is satisfied', function(done) {
      User.find({where: {or: [
        {name: 'John Lennon'},
        {role: 'lead'},
      ]}}, function(err, users) {
    ...
    it.skip('should support "or" operator that is not satisfied', function(done) {
      User.find({where: {or: [
        {name: 'XYZ'},
        {role: 'Hello1'},
      ]}}, function(err, users) {
    ...
    it.skip('should support date "gte" that is satisfied', function(done) {
    ...
    it.skip('should support date "gt" that is not satisfied', function(done) {
    ...
    it.skip('should support date "gt" that is satisfied', function(done) {
    ...
    it.skip('should support number "gte" that is satisfied', function(done) {
    ...
    it.skip('should support number "gt" that is not satisfied', function(done) {
    ...
    it.skip('should support number "gt" that is satisfied', function(done) {
    ...
    it.skip('should support number "lt" that is satisfied', function(done) {
    ...
    it.skip('should support number "gt" that is satisfied by null value', function(done) {
    ...
    it.skip('should support number "lt" that is not satisfied by null value', function(done) {
    ...
    it.skip('should support string "gte" that is satisfied by null value', function(done) {
    ...
    it.skip('should support string "gte" that is satisfied', function(done) {
    ...
    it.skip('should support string "gt" that is not satisfied', function(done) {
    ...
    it.skip('should support string "gt" that is satisfied', function(done) {
    ...
    it.skip('should support string "lt" that is satisfied', function(done) {
    ...
    it.skip('should support boolean "gte" that is satisfied', function(done) {
    ...
    it.skip('should support boolean "gt" that is not satisfied', function(done) {
    ...
    it.skip('should support boolean "gt" that is satisfied', function(done) {
    ...
    it.skip('should support boolean "lt" that is satisfied', function(done) {
    ...
    it.skip('should only include fields as specified', function(done) {
      var remaining = 0;
